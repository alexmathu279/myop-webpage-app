    ...
    <div className="register-shell">
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 860px) { .register-body { grid-template-columns: 1fr; padding: 24px 16px; } .register-intro { margin-bottom: 24px; padding-right: 0; } }
        .register-intro { padding-right: 48px; } 
        @media (min-width: 861px) { .register-intro { position: sticky; top: 80px; } }
