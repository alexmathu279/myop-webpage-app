...
const SERVICES = [
  {
    ...
    image:    '/images/premium/aster1.png',
  },
  {
    label:    'Diagnostics',
  ...
  return (
    <div className="landing">
      ...
      <div className="partner-strip">
        <span>Are you a Hospital or Clinic?</span>
        <a href="/register">List your facility →</a>
      </div>
        ...
        <div className="services-scroll">
          {SERVICES.map(s => (
            <Link
              ...
              style={{
                  backgroundImage: `${s.gradient}, url(${s.image})`,
      ...
      <style>{`
        ...
        .landing-footer__links a:hover::after {
          width: 100%;
        }
        ...
        * {
        ...
        /* Partner CTA (Footer safe placement) */
        .partner-cta {
          margin-top: 20px;
          padding: 14px 20px;
          border-radius: 12px;
